...
public class ModDataComponents {
    ...
    public static final Supplier<DataComponentType<ItemContainerContents>> SWORD_TYPE = REGISTRAR.registerComponentType(
            "sword_type",
            builder -> builder
...
//    public static final DeferredHolder<DataComponentType<?>, DataComponentType<ItemContainerContents>> SWORD_TYPE = register("pick_type",
