...
public class PiglinFarmBlock extends BlockBase implements EntityBlock, IItemBlock {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> components, TooltipFlag tooltipFlag) {
        ...
        if (Screen.hasShiftDown()) {
            components.add(Component.literal("Must be in the Nether or on any Nether Stones to work")
            ...
            components.add(Component.translatable("tooltip.mobfarms.piglin_farm.hint")
    ...
    public void setPlacedBy(Level level, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack stack) {
        ...
        if (blockEntity instanceof IronFarmTileentity farmTileEntity) {
