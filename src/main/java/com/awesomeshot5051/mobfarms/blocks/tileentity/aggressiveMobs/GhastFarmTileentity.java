...
/*    0 */ import net.minecraft.world.entity.monster.Ghast;
...
/*    0 */ 
/*    0 */ public class GhastFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> GHAST_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/ghast"));
/*    0 */   
...
/*    0 */   
/*    0 */   public GhastFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.GHAST_FARM.get(), ((GhastFarmBlock)ModBlocks.GHAST_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getGhastSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.ghastSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getGhastExplodeTime() {
/*   57 */     return getGhastSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getGhastSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getGhastExplodeTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Ghast(EntityType.GHAST, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().explosion(null));
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(GHAST_LOOT_TABLE);
