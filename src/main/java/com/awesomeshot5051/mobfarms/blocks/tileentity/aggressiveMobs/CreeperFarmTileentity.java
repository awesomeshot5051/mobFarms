...
/*    0 */ import net.minecraft.world.entity.monster.Creeper;
...
/*    0 */ 
/*    0 */ public class CreeperFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> CREEPER_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/creeper"));
/*    0 */   
...
/*    0 */   
/*    0 */   public CreeperFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.CREEPER_FARM.get(), ((CreeperFarmBlock)ModBlocks.CREEPER_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getCreeperSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.creeperSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getCreeperExplodeTime() {
/*   57 */     return getCreeperSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getCreeperSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getCreeperExplodeTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Creeper(EntityType.CREEPER, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().explosion(null));
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(CREEPER_LOOT_TABLE);
