...
/*    0 */ import net.minecraft.world.entity.monster.Witch;
...
/*    0 */ 
/*    0 */ public class WitchFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> WITCH_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/witch"));
/*    0 */   
...
/*    0 */   
/*    0 */   public WitchFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.WITCH_FARM.get(), ((WitchFarmBlock)ModBlocks.WITCH_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getWitchSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.witchSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getWitchExplodeTime() {
/*   57 */     return getWitchSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getWitchSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getWitchExplodeTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Witch(EntityType.WITCH, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().explosion(null));
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(WITCH_LOOT_TABLE);
