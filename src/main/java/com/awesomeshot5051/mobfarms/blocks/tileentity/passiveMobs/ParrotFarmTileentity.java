...
/*    0 */ import net.minecraft.world.entity.animal.Parrot;
...
/*    0 */ 
/*    0 */ public class ParrotFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   38 */   private static final ResourceKey<LootTable> PARROT_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/parrot"));
/*    0 */   
...
/*    0 */   
/*    0 */   public ParrotFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.PARROT_FARM.get(), ((ParrotFarmBlock)ModBlocks.PARROT_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getParrotSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.parrotSpawnTime.get()).intValue() - 200;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getParrotKillTime() {
/*   57 */     return getParrotSpawnTime() + 200;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getParrotSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getParrotKillTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Parrot(EntityType.PARROT, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().lava());
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(PARROT_LOOT_TABLE);
