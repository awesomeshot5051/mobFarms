...
/*    0 */ import net.minecraft.world.entity.monster.Skeleton;
...
/*    0 */ 
/*    0 */ public class SkeletonFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> SKELETON_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/skeleton"));
/*    0 */   
...
/*    0 */   
/*    0 */   public SkeletonFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.SKELETON_FARM.get(), ((SkeletonFarmBlock)ModBlocks.SKELETON_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getSkeletonSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.skeletonSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getSkeletonExplodeTime() {
/*   57 */     return getSkeletonSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getSkeletonSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getSkeletonExplodeTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Skeleton(EntityType.SKELETON, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().explosion(null));
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(SKELETON_LOOT_TABLE);
