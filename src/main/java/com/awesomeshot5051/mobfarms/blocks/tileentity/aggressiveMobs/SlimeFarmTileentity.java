...
/*    0 */ import net.minecraft.world.entity.monster.Slime;
...
/*    0 */ 
/*    0 */ public class SlimeFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> SLIME_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/slime"));
/*    0 */   
...
/*    0 */   
/*    0 */   public SlimeFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.SLIME_FARM.get(), ((SlimeFarmBlock)ModBlocks.SLIME_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getSlimeSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.slimeSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getSlimeExplodeTime() {
/*   57 */     return getSlimeSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getSlimeSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getSlimeExplodeTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Slime(EntityType.SLIME, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().explosion(null));
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(SLIME_LOOT_TABLE);
