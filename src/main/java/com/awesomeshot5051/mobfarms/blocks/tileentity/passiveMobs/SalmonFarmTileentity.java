...
public class SalmonFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public static double getSalmonSpawnTime(SalmonFarmTileentity farm) {
        ...
        return (double) Main.SERVER_CONFIG.salmonSpawnTime.get() /
    ...
    public static double getSalmonKillTime(SalmonFarmTileentity farm) {
        ...
        return getSalmonSpawnTime(farm) + (sword.equals(SwordType.NETHERITE) ? (baseValue * 3.2) :
...
//            }
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(SwordEnchantments.getEnchantmentStatus(swordEnchantments, Enchantments.FIRE_ASPECT) ? Items.COOKED_SALMON : Items.SALMON, dropCount));
