...
/*    0 */ import net.minecraft.world.entity.monster.Guardian;
...
/*    0 */ 
/*    0 */ public class GuardianFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> GUARDIAN_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/guardian"));
/*    0 */   
...
/*    0 */   
/*    0 */   public GuardianFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.GUARDIAN_FARM.get(), ((GuardianFarmBlock)ModBlocks.GUARDIAN_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getGuardianSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.guardianSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getGuardianExplodeTime() {
/*   57 */     return getGuardianSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getGuardianSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getGuardianExplodeTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Guardian(EntityType.GUARDIAN, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().explosion(null));
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(GUARDIAN_LOOT_TABLE);
