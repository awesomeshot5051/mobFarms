...
/*    0 */ import net.minecraft.world.entity.monster.Evoker;
...
/*    0 */ 
/*    0 */ public class EvokerFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> EVOKER_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/evoker"));
/*    0 */   
...
/*    0 */   
/*    0 */   public EvokerFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.EVOKER_FARM.get(), ((EvokerFarmBlock)ModBlocks.EVOKER_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getEvokerSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.evokerSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getEvokerExplodeTime() {
/*   57 */     return getEvokerSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getEvokerSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getEvokerExplodeTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Evoker(EntityType.EVOKER, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().explosion(null));
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(EVOKER_LOOT_TABLE);
