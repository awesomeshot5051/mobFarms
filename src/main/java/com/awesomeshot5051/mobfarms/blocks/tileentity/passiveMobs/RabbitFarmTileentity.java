...
/*    0 */ import net.minecraft.world.entity.animal.Rabbit;
...
/*    0 */ 
/*    0 */ public class RabbitFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> RABBIT_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/rabbit"));
/*    0 */   
...
/*    0 */   
/*    0 */   public RabbitFarmTileentity(BlockPos pos, BlockState state) {
/*   47 */     super((BlockEntityType)ModTileEntities.RABBIT_FARM.get(), ((RabbitFarmBlock)ModBlocks.RABBIT_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getRabbitSpawnTime() {
/*   54 */     return ((Integer)Main.SERVER_CONFIG.rabbitSpawnTime.get()).intValue() - 200;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getRabbitKillTime() {
/*   58 */     return getRabbitSpawnTime() + 200;
/*    0 */   }
/*    0 */   
...
/*   74 */     this.timer++;
/*   75 */     setChanged();
/*   77 */     if (this.timer == getRabbitSpawnTime()) {
/*   79 */       sync();
/*   80 */     } else if (this.timer > getRabbitSpawnTime() && this.timer < getRabbitKillTime()) {
/*   81 */       if (this.timer % 20L == 0L);
/*   84 */     } else if (this.timer >= getRabbitKillTime()) {
