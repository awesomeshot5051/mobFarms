...
/*    0 */ import net.minecraft.world.entity.monster.Shulker;
...
/*    0 */ 
/*    0 */ public class ShulkerFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> SHULKER_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/shulker"));
/*    0 */   
...
/*    0 */   
/*    0 */   public ShulkerFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.SHULKER_FARM.get(), ((ShulkerFarmBlock)ModBlocks.SHULKER_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getShulkerSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.shulkerSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getShulkerExplodeTime() {
/*   57 */     return getShulkerSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getShulkerSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getShulkerExplodeTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Shulker(EntityType.SHULKER, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().explosion(null));
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(SHULKER_LOOT_TABLE);
