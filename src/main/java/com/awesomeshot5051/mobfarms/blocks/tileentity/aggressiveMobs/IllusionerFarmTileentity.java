...
/*    0 */ import net.minecraft.world.entity.monster.Illusioner;
...
/*    0 */ 
/*    0 */ public class IllusionerFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   39 */   private static final ResourceKey<LootTable> ILLUSIONER_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/illusioner"));
/*    0 */   
...
/*    0 */   
/*    0 */   public IllusionerFarmTileentity(BlockPos pos, BlockState state) {
/*   48 */     super((BlockEntityType)ModTileEntities.ILLUSIONER_FARM.get(), ((IllusionerFarmBlock)ModBlocks.ILLUSIONER_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getIllusionerSpawnTime() {
/*   55 */     return ((Integer)Main.SERVER_CONFIG.illusionerSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getIllusionerExplodeTime() {
/*   59 */     return getIllusionerSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   71 */     this.timer++;
/*   72 */     setChanged();
/*   74 */     if (this.timer == getIllusionerSpawnTime()) {
/*   77 */       sync();
/*   82 */     } else if (this.timer >= getIllusionerExplodeTime()) {
...
/*    0 */     } 
/*  103 */     List<ItemStack> drops = new ArrayList<>();
/*  107 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Illusioner(EntityType.ILLUSIONER, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().explosion(null));
/*  109 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  111 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(ILLUSIONER_LOOT_TABLE);
/*  112 */     drops.addAll((Collection<? extends ItemStack>)lootTable.getRandomItems(lootContext));
/*  113 */     drops.add(new ItemStack((ItemLike)Items.DIAMOND));
/*  115 */     return drops;
/*    0 */   }
/*    0 */   
/*    0 */   public Container getOutputInventory() {
/*  119 */     return (Container)new ItemListInventory(this.inventory, this::setChanged);
/*    0 */   }
/*    0 */   
/*    0 */   protected void saveAdditional(CompoundTag compound, HolderLookup.Provider provider) {
/*  124 */     super.saveAdditional(compound, provider);
/*  126 */     ContainerHelper.saveAllItems(compound, this.inventory, false, provider);
/*  127 */     compound.putLong("Timer", this.timer);
/*    0 */   }
/*    0 */   
/*    0 */   protected void loadAdditional(CompoundTag compound, HolderLookup.Provider provider) {
/*  132 */     ContainerHelper.loadAllItems(compound, this.inventory, provider);
/*  133 */     this.timer = compound.getLong("Timer");
/*  134 */     super.loadAdditional(compound, provider);
/*    0 */   }
/*    0 */   
/*    0 */   public IItemHandler getItemHandler() {
/*  138 */     return (IItemHandler)this.outputItemHandler;
/*    0 */   }
/*    0 */ }
