...
//            // VillagerBlockBase.playVillagerSound(level, getBlockPos(), SoundEvents.CREEPER_DEATH);
    ...
    private List<ItemStack> getDrops() {
        ...
        return Collections.singletonList(new ItemStack(SwordEnchantments.getEnchantmentStatus(swordEnchantments, Enchantments.FIRE_ASPECT) ? Items.COOKED_COD : Items.COD, dropCount));
    }
