...
/*    0 */ import net.minecraft.world.entity.monster.hoglin.Hoglin;
...
/*    0 */ 
/*    0 */ public class HoglinFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> HOGLIN_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/hoglin"));
/*    0 */   
...
/*    0 */   
/*    0 */   public HoglinFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.HOGLIN_FARM.get(), ((HoglinFarmBlock)ModBlocks.HOGLIN_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getHoglinSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.hoglinSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getHoglinExplodeTime() {
/*   57 */     return getHoglinSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getHoglinSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getHoglinExplodeTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Hoglin(EntityType.HOGLIN, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().explosion(null));
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(HOGLIN_LOOT_TABLE);
