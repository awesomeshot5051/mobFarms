...
/*    0 */ import net.minecraft.world.entity.monster.Zombie;
...
/*    0 */ 
/*    0 */ public class ZombieFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> ZOMBIE_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/zombie"));
/*    0 */   
...
/*    0 */   
/*    0 */   public ZombieFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.ZOMBIE_FARM.get(), ((ZombieFarmBlock)ModBlocks.ZOMBIE_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getZombieSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.zombieSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getZombieExplodeTime() {
/*   57 */     return getZombieSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getZombieSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getZombieExplodeTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Zombie(EntityType.ZOMBIE, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().explosion(null));
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(ZOMBIE_LOOT_TABLE);
