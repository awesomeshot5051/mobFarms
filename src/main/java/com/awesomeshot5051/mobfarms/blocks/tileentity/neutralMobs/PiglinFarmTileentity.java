...
/*    0 */ import net.minecraft.world.entity.monster.piglin.Piglin;
...
/*    0 */ 
/*    0 */ public class PiglinFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   38 */   private static final ResourceKey<LootTable> PIGLIN_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/piglin"));
/*    0 */   
...
/*    0 */   
/*    0 */   public PiglinFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.PIGLIN_FARM.get(), ((PiglinFarmBlock)ModBlocks.PIGLIN_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getPiglinSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.piglinSpawnTime.get()).intValue() - 200;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getPiglinKillTime() {
/*   57 */     return getPiglinSpawnTime() + 200;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getPiglinSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getPiglinKillTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Piglin(EntityType.PIGLIN, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().lava());
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(PIGLIN_LOOT_TABLE);
