...
/*    0 */ import net.minecraft.world.entity.monster.Ravager;
...
/*    0 */ 
/*    0 */ public class RavagerFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> RAVAGER_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/ravager"));
/*    0 */   
...
/*    0 */   
/*    0 */   public RavagerFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.RAVAGER_FARM.get(), ((RavagerFarmBlock)ModBlocks.RAVAGER_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getRavagerSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.ravagerSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getRavagerExplodeTime() {
/*   57 */     return getRavagerSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getRavagerSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getRavagerExplodeTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Ravager(EntityType.RAVAGER, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().explosion(null));
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(RAVAGER_LOOT_TABLE);
