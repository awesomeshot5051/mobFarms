...
/*    0 */ import net.minecraft.world.entity.monster.Spider;
...
/*    0 */ 
/*    0 */ public class SpiderFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   38 */   private static final ResourceKey<LootTable> SPIDER_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/spider"));
/*    0 */   
...
/*    0 */   
/*    0 */   public SpiderFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.SPIDER_FARM.get(), ((SpiderFarmBlock)ModBlocks.SPIDER_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getSpiderSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.spiderSpawnTime.get()).intValue() - 200;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getSpiderKillTime() {
/*   57 */     return getSpiderSpawnTime() + 200;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getSpiderSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getSpiderKillTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Spider(EntityType.SPIDER, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().lava());
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(SPIDER_LOOT_TABLE);
