...
/*    0 */ import net.minecraft.world.entity.animal.Pufferfish;
...
/*    0 */ 
/*    0 */ public class PufferfishFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> PUFFERFISH_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/pufferfish"));
/*    0 */   
...
/*    0 */   
/*    0 */   public PufferfishFarmTileentity(BlockPos pos, BlockState state) {
/*   45 */     super((BlockEntityType)ModTileEntities.PUFFERFISH_FARM.get(), ((PufferfishFarmBlock)ModBlocks.PUFFERFISH_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getPufferfishSpawnTime() {
/*   52 */     return ((Integer)Main.SERVER_CONFIG.pufferfishSpawnTime.get()).intValue() - 200;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getPufferfishKillTime() {
/*   56 */     return getPufferfishSpawnTime() + 200;
/*    0 */   }
/*    0 */   
...
/*   65 */     this.timer++;
/*   66 */     setChanged();
/*   68 */     if (this.timer == getPufferfishSpawnTime()) {
/*   69 */       sync();
/*   70 */     } else if (this.timer >= getPufferfishKillTime()) {
...
/*    0 */     } 
/*   93 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Pufferfish(EntityType.PUFFERFISH, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().lava());
/*   95 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*   97 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(PUFFERFISH_LOOT_TABLE);
