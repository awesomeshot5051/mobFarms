...
public class WardenFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
    ...
    public static double getWardenSpawnTime(WardenFarmTileentity farm) {
        SwordType sword = SwordType.fromItem(farm.getSwordType().getItem());
        return (double) Main.SERVER_CONFIG.wardenSpawnTime.get() /
    ...
    public static double getWardenExplodeTime(WardenFarmTileentity farm) {
        ...
        return getWardenSpawnTime(farm) + (sword.equals(SwordType.NETHERITE) ? (baseValue * 3.2) :
...
//        BlockBase.playRandomVillagerSound(level, getBlockPos(), SoundEvents.WARDEN_PRIMED);
        ...
        if (timer == getWardenSpawnTime(this)) {
...
//            }
        } else if (timer >= getWardenExplodeTime(this)) {
...
//            // VillagerBlockBase.playVillagerSound(level, getBlockPos(), SoundEvents.WARDEN_DEATH);
    ...
    private List<ItemStack> getDrops() {
        ...
        drops.add(new ItemStack(Items.SCULK_CATALYST, dropCount));
