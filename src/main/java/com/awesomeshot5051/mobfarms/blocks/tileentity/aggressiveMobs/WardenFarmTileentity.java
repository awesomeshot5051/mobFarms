...
/*    0 */ import net.minecraft.world.entity.monster.warden.Warden;
...
/*    0 */ 
/*    0 */ public class WardenFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> WARDEN_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/warden"));
/*    0 */   
...
/*    0 */   
/*    0 */   public WardenFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.WARDEN_FARM.get(), ((WardenFarmBlock)ModBlocks.WARDEN_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getWardenSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.wardenSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getWardenExplodeTime() {
/*   57 */     return getWardenSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getWardenSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getWardenExplodeTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new Warden(EntityType.WARDEN, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().explosion(null));
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(WARDEN_LOOT_TABLE);
