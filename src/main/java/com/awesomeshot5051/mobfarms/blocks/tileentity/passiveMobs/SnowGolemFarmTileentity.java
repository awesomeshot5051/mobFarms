...
//            }
    ...
    private List<ItemStack> getDrops() {
        ...
        int dropCount = SwordEnchantments.getEnchantmentStatus(swordEnchantments, Enchantments.LOOTING) ? serverWorld.random.nextIntBetweenInclusive(10, 15) : serverWorld.random.nextIntBetweenInclusive(1, 9);
        if (serverWorld.random.nextFloat() >= .05) {
            drops.add(new ItemStack(Items.CARVED_PUMPKIN));
        }
        drops.add(new ItemStack(Items.SNOWBALL, dropCount));
