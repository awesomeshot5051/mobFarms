...
/*    0 */ import net.minecraft.world.entity.animal.SnowGolem;
...
/*    0 */ 
/*    0 */ public class SnowGolemFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   37 */   private static final ResourceKey<LootTable> SNOWGOLEM_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/snow_golem"));
/*    0 */   
...
/*    0 */   
/*    0 */   public SnowGolemFarmTileentity(BlockPos pos, BlockState state) {
/*   47 */     super((BlockEntityType)ModTileEntities.SNOW_GOLEM_FARM.get(), ((SnowGolemFarmBlock)ModBlocks.SNOW_GOLEM_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getSnowGolemSpawnTime() {
/*   54 */     return ((Integer)Main.SERVER_CONFIG.snowGolemSpawnTime.get()).intValue() - 200;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getSnowGolemKillTime() {
/*   58 */     return getSnowGolemSpawnTime() + 200;
/*    0 */   }
/*    0 */   
...
/*   74 */     this.timer++;
/*   75 */     setChanged();
/*   77 */     if (this.timer == getSnowGolemSpawnTime()) {
/*   79 */       sync();
/*   80 */     } else if (this.timer > getSnowGolemSpawnTime() && this.timer < getSnowGolemKillTime()) {
/*   81 */       if (this.timer % 20L == 0L);
/*   84 */     } else if (this.timer >= getSnowGolemKillTime()) {
