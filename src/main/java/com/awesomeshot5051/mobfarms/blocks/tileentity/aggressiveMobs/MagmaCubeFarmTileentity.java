...
//            // VillagerBlockBase.playVillagerSound(level, getBlockPos(), SoundEvents.MAGMACUBE_DEATH);
    ...
    private List<ItemStack> getDrops() {
        ...
        LootParams.Builder builder = new LootParams.Builder(serverWorld)
                .withParameter(LootContextParams.THIS_ENTITY, new MagmaCube(EntityType.MAGMA_CUBE, level))
        ...
        LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(MAGMACUBE_LOOT_TABLE);
