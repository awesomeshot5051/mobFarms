...
/*    0 */ 
/*    0 */ public class MagmaCubeFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   33 */   private static final ResourceKey<LootTable> MAGMACUBE_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/magma_cube"));
/*    0 */   
...
/*    0 */   
/*    0 */   public MagmaCubeFarmTileentity(BlockPos pos, BlockState state) {
/*   42 */     super((BlockEntityType)ModTileEntities.MAGMA_CUBE_FARM.get(), ((MagmaCubeFarmBlock)ModBlocks.MAGMA_CUBE_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getMagmaCubeSpawnTime() {
/*   49 */     return ((Integer)Main.SERVER_CONFIG.magmaCubeSpawnTime.get()).intValue() - 80;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getMagmaCubeExplodeTime() {
/*   53 */     return getMagmaCubeSpawnTime() + 80;
/*    0 */   }
/*    0 */   
...
/*   65 */     this.timer++;
/*   66 */     setChanged();
/*   68 */     if (this.timer == getMagmaCubeSpawnTime()) {
/*   71 */       sync();
/*   76 */     } else if (this.timer >= getMagmaCubeExplodeTime()) {
...
/*  104 */       drops.add(new ItemStack((ItemLike)Items.MAGMA_CREAM, dropCount));
/*    0 */     } 
/*  110 */     return drops;
/*    0 */   }
/*    0 */   
