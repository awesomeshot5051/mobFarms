...
/*    0 */ import net.minecraft.world.entity.GlowSquid;
...
/*    0 */ 
/*    0 */ public class GlowSquidFarmTileentity extends VillagerTileentity implements ITickableBlockEntity {
/*   38 */   private static final ResourceKey<LootTable> GLOWSQUID_LOOT_TABLE = ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace("entities/glow_squid"));
/*    0 */   
...
/*    0 */   
/*    0 */   public GlowSquidFarmTileentity(BlockPos pos, BlockState state) {
/*   46 */     super((BlockEntityType)ModTileEntities.GLOW_SQUID_FARM.get(), ((GlowSquidFarmBlock)ModBlocks.GLOW_SQUID_FARM.get()).defaultBlockState(), pos, state);
...
/*    0 */   }
/*    0 */   
/*    0 */   public static int getGlowSquidSpawnTime() {
/*   53 */     return ((Integer)Main.SERVER_CONFIG.glowSquidSpawnTime.get()).intValue() - 200;
/*    0 */   }
/*    0 */   
/*    0 */   public static int getGlowSquidKillTime() {
/*   57 */     return getGlowSquidSpawnTime() + 200;
/*    0 */   }
/*    0 */   
...
/*   69 */     this.timer++;
/*   70 */     setChanged();
/*   72 */     if (this.timer == getGlowSquidSpawnTime()) {
/*   75 */       sync();
/*   80 */     } else if (this.timer >= getGlowSquidKillTime()) {
...
/*    0 */     } 
/*  105 */     LootParams.Builder builder = (new LootParams.Builder(serverWorld)).withParameter(LootContextParams.THIS_ENTITY, new GlowSquid(EntityType.GLOW_SQUID, this.level)).withParameter(LootContextParams.ORIGIN, new Vec3(this.worldPosition.getX(), this.worldPosition.getY(), this.worldPosition.getZ())).withParameter(LootContextParams.DAMAGE_SOURCE, serverWorld.damageSources().lava());
/*  107 */     LootParams lootContext = builder.create(LootContextParamSets.ENTITY);
/*  109 */     LootTable lootTable = serverWorld.getServer().reloadableRegistries().getLootTable(GLOWSQUID_LOOT_TABLE);
